...
export function Login() {
  ...
  return (
    <div>
        <header className="flex justify-center items-center flex-col gap-4 text-center">
          <h1 className="text-2xl font-bold text-gray-900 tracking-[-0.5px]">Entre sua conta</h1>
